            ...
            <section className="about-section three">
                <div className="auto-container">
                    <div className="row">
                        ...
                        <div className="col-lg-6">
                            <div
                                className="right-wrapper pl-40 wow animated fadeInRight"
                                data-wow-duration="1.5s"
                                data-wow-delay="0.3s"
                            >
                                        ...
                                        <li>
                                            ...
                                            <div>
                                                ...
                                                <p>
                                                    ...
                                                    solutions. Read more about our machine learning services.
                                                </p>
                                            </div>
                                        </li>
                                        <li>
                ...
                <div className="shape-img">
                    <img
                        ...
                        alt=""
                    />
                    <img className="shape-2 poa" src="/assets/img/icon/84_icon.png" alt="" />
                </div>
            </section>
