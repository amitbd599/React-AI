        ...
        <>
            ...
            <section className="about-section two">
                    ...
                    <div className="row">
                        ...
                        >
                            <div className="section-title-shape-one">
                                ...
                                <p>
                                    Artificial Intelligence as a Service (AIaaS) is the third-party
                                    offering of artificial intelligence (AI) outsourcing. It enables
                                    individuals and companies to experiment with AI for various
                                    purposes without a large initial investment and with lower risk.
                                </p>
                            </div>
                            <div className="inner-list">
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        services with prebuilt machine.
                                    </li>
                                    <li>
                ...
                <div className="shape-img">
                    <img className="shape-1 poa" src="/assets/img/icon/21_icon.png" alt="" />
                    <img className="shape-2 poa" src="/assets/img/icon/90_icon.png" alt="" />
                    <img className="shape-3 poa" src="/assets/img/icon/91_icon.png" alt="" />
                    <img className="shape-4 poa" src="/assets/img/icon/15_icon.png" alt="" />
                    <img className="shape-5 poa" src="/assets/img/icon/43_icon.png" alt="" />
                    <img className="shape-6 poa" src="/assets/img/icon/27_icon.png" alt="" />
                    ...
                    <img
                        ...
                        alt=""
                    />
                    <img className="shape-9 poa" src="/assets/img/icon/44_icon.png" alt="" />
                    <img
