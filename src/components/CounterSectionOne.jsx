    ...
    return (
        <>
            ...
            <section
                ...
                style={{
                    backgroundImage:
                        "url('/assets/img/bg-image/04_bg-image.jpg')",
                }}
            >
                <div className="auto-container">
                    <div
                        className="award-part wow animated fadeInUp"
                            ...
                            <div className="col-lg-6">
                                ...
                                >
                                    <div className="title-des">
                                        ...
                                        <p>
                                            This refers to the general concept of machines acting in a way
                                            that simulates or mimics human intelligence. AI can have a
                                            variety of features, such as human-like communication or
                                            decision making.
                                        </p>
                                    </div>
                                    <div className="list">
                                            ...
                                            <div className="item mt-30">
                                                <div className="count-body">
                                                    <h2 className="counter">
                                                        <ReactVisibilitySensor>
                                                            {({ isVisible }) =>
                                                                <div> {isVisible ? (<CountUp end={682} />) : 0}</div>
                                                            }
                                                        </ReactVisibilitySensor>
                                                    </h2>
                                                    <h4>+</h4>
                                            ...
                                            <div className="item">
                                                <div className="count-body">
                                                    <h2 className="counter">
                                                        <ReactVisibilitySensor>
                                                            {({ isVisible }) =>
                                                                <div> {isVisible ? (<CountUp end={52} />) : 0}</div>
                                                            }
                                                        </ReactVisibilitySensor>
                                                    </h2>
                                                    <h4>+</h4>
                                            ...
                                            <div className="item mt-30">
                                                <div className="count-body">
                                                    <h2 className="counter">
                                                        <ReactVisibilitySensor>
                                                            {({ isVisible }) =>
                                                                <div> {isVisible ? (<CountUp end={43} />) : 0}</div>
                                                            }
                                                        </ReactVisibilitySensor>
                                                    </h2>
                                                    <h4>+</h4>
