            ...
            >
                <div className="auto-container">
                    <div className="row">
                        ...
                        <div className="col-lg-3 col-md-6 col-12">
                            <div
                                className="wrapper mt-md-0 mt-4 wow animated fadeInUp"
                                data-wow-duration="1s"
                                data-wow-delay="0.3s"
                            >
                                <div>
                        ...
                        <div className="col-lg-3 col-md-6 col-12">
                            <div
                                className="wrapper mt-lg-0 mt-4 wow animated fadeInUp"
                                data-wow-duration="1s"
                                data-wow-delay="0.4s"
                            >
                                <div>
                ...
                <div className="shape-img">
                    <img className="shape-1 poa" src="/assets/img/icon/93_icon.png" alt="" />
                    <img className="shape-2 poa" src="/assets/img/icon/77_icon.png" alt="" />
                </div>
            </section>
