        ...
        <>
            ...
            <section className="faq-section one two">
                <div className="auto-container">
                    <div className="row">
                        ...
                        <div className="col-lg-8">
                            <div
                                className="faq-inner wow animated fadeInRight"
                                data-wow-duration="1.5s"
                                data-wow-delay="0.3s"
                            >
                                        ...
                                        <div className="accordion-item">
                                            ...
                                            >
                                                <div className="accordion-body">
                                                    ...
                                                    post, ML is a subset of AI. Not all AI systems learn from
                                                    experience but ML-enabled devices do. Very simply put, all
                                                    ML systems are AI but not all AI machines are ML-capable.
                                                    As you may have read in our AI, ML, and deep learning
                                                    post, ML is a subset of AI. Not all AI systems learn from
                                                    experience but ML-enabled devices do. Very simply put, all
                                                    ML systems are AI but not all AI machines are ML-capable.
                ...
                <div className="shape-image">
                    <img className="shape-1 poa" src="/assets/img/icon/57_icon.png" alt="" />
                    <img className="shape-2 poa" src="/assets/img/icon/22_icon.png" alt="" />
                    <img className="shape-3 poa" src="/assets/img/icon/75_icon.png" alt="" />
                </div>
            </section>
            {/* FAQ Section two end */}
        </>
