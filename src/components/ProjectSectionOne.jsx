                ...
                <div className="auto-container">
                    ...
                    <div className="row">
                        <div className="col-lg-6">
                            <div
                                className="project-wrapper wow animated fadeInLeft"
                                data-wow-duration="1.5s"
                                data-wow-delay="0.3s"
                            >
                                <div className="img-file por">
                                    ...
                                    <div className="shape-overlay poa">
                                        ...
                                        <p>
                                            ...
                                            impactful Artificial Intelligence projects, from cutting-edge
                        ...
                        <div className="col-lg-6">
                            <div
                                className="project-wrapper wow animated fadeInRight"
                                data-wow-duration="1.5s"
                                data-wow-delay="0.3s"
                            >
                                <div className="img-file por">
