            ...
            <div className="swiper hero-slider-init-one swiper-container swiper-container-fade">
                <div className="swiper-wrapper p-relative">
                    <div className="item-slider sliderm-height p-relative swiper-slide">
                        <div
                            className="slide-bg"
                            data-background="assets/img/bg-image/01_bg-image.png"
                        />
                                    ...
                                    <div className="slider-content-inner ">
                                        <div>
                                            ...
                                            <p className="description">
                                                ...
                                                from it but right to find fault with a man who chooses
                    ...
                    <div className="item-slider sliderm-height p-relative swiper-slide">
                        <div
                            className="slide-bg"
                            data-background="assets/img/bg-image/02_bg-image.png"
                        />
                        <div className="auto-container">
                            <div className="row ">
                                <div className="col-xl-7 col-12">
                                    <div className="slider-content-inner ">
                                        <div>
                                            ...
                                            <p className="description">
                                                AI for customer engagement, improving customer service for
                                                companies with tools like AI chatbots. We offer AI
                                                consulting services and solutions that will help you achieve
                    ...
                    <div className="item-slider sliderm-height p-relative swiper-slide">
                        <div
                            className="slide-bg"
                            data-background="assets/img/bg-image/03_bg-image.png"
                        />
                        <div className="auto-container">
                            <div className="row ">
                                <div className="col-xl-7 col-12">
                ...
                <div className="shape-image">
                    <div className="inner-shape-1 poa">
                        <img className="img-fluid" src="assets/img/icon/01_icon.png" alt="" />
                    </div>
                    <div className="inner-shape-2 poa">
                        <img className="img-fluid" src="assets/img/icon/02_icon.png" alt="" />
                    </div>
                    <div className="inner-shape-3 poa">
                        <img className="img-fluid" src="assets/img/icon/03_icon.png" alt="" />
                    </div>
                    <div className="inner-shape-4 poa">
                        <img className="img-fluid" src="assets/img/icon/04_icon.png" alt="" />
                    </div>
                    <div className="inner-shape-5 poa">
                        <img className="img-fluid" src="assets/img/icon/04_icon.png" alt="" />
                    </div>
                    <div className="inner-shape-6 poa">
                        <img className="img-fluid" src="assets/img/icon/06_icon.png" alt="" />
                    </div>
                    <div className="inner-shape-7 poa">
                        <img className="img-fluid" src="assets/img/icon/07_icon.png" alt="" />
                    </div>
                    <div className="inner-shape-8 poa">
                        <img className="img-fluid" src="assets/img/icon/08_icon.png" alt="" />
                    </div>
                    <div className="inner-shape-9 poa">
                        <img className="img-fluid" src="assets/img/icon/27_icon.png" alt="" />
                    </div>
                </div>
            </div>
        </section>
