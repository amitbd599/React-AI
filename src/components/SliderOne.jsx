                ...
                <div className="swiper hero-slider-init-one swiper-container swiper-container-fade">
                    <div className="swiper-wrapper p-relative">
                        <Swiper
                            ...
                            effect='fade'
                        >
                            <SwiperSlide><div className="item-slider sliderm-height p-relative swiper-slide">
                                <div
                                    className="slide-bg"
                                            ...
                                            <div className="slider-content-inner ">
                                                <div>
                                                    ...
                                                    <p className="description">
                                                        ...
                                                        advantage from it but right to find fault with a man who
                                                        chooses enjoy. for your business work.
                                                    </p>
                                            ...
                                            <div className="slider-content-inner ">
                                                <div>
                                                    ...
                                                    <p className="description">
                                                        ...
                                                        consulting services and solutions that will help you
